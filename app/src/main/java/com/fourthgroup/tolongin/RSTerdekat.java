...
public class RSTerdekat<MapsActivity> extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rsterdekat);
    ...
    private void checkPermission() {
        int permissionLocation = ContextCompat.checkSelfPermission(RSTerdekat.this, Manifest.permission.ACCESS_FINE_LOCATION);
    ...
    private void getMyLocation(){
        if(mGoogleApiClient!=null) {
            if (mGoogleApiClient.isConnected()) {
                int permissionLocation = ContextCompat.checkSelfPermission(RSTerdekat.this,
                            ...
                            switch (status.getStatusCode()) {
                                case LocationSettingsStatusCodes.SUCCESS:
                                    ...
                                    int permissionLocation = ContextCompat
                                            .checkSelfPermission(RSTerdekat.this,
                                                    Manifest.permission.ACCESS_FINE_LOCATION);
                                    if (permissionLocation == PackageManager.PERMISSION_GRANTED) {
                                ...
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        status.startResolutionForResult(RSTerdekat.this,
